        ...
        <Layout>
            ...
            <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
                <div
                    ...
                    style={{ backgroundImage: 'url("https://images.unsplash.com/photo-1595428774223-ef52624120d2?q=80&w=2000&auto=format&fit=crop")' }}
                >
                    ...
                    <div className="container mx-auto px-4">
                        <div className={`flex flex-col ${dir === 'rtl' ? 'lg:flex-row-reverse' : 'lg:flex-row'} gap-12 items-center`}>
                            ...
                            <div className="lg:w-1/2">
                                ...
                                >
                                    <img
                                        src="https://images.unsplash.com/photo-1616486341351-70252447c274?q=80&w=1000&auto=format&fit=crop"
                                        alt="Sliding Closet"
                    ...
                    <div className="container mx-auto px-4">
                        <div className={`flex flex-col ${dir === 'rtl' ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-12 items-center`}>
                            ...
                            <div className="lg:w-1/2">
                                ...
                                >
                                    <img
                                        src="https://images.unsplash.com/photo-1518481612222-68bbe828ecd1?q=80&w=1000&auto=format&fit=crop"
                                        alt="Hinged Closet"
                                        className="w-full h-full object-cover"
                                    />
                                </motion.div>
                ...
                <section className="py-20">
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                            {[
                                { key: 'hallway', icon: LayoutIcon, img: 'https://images.unsplash.com/photo-1620626011761-9963d751857d?q=80&w=1000&auto=format&fit=crop' },
                                { key: 'bedroom', icon: Bed, img: 'https://images.unsplash.com/photo-1558976825-6b1b03a03719?q=80&w=1000&auto=format&fit=crop' },
                                { key: 'kids', icon: Baby, img: 'https://images.unsplash.com/photo-1595844730298-b9f0ff98fee0?q=80&w=1000&auto=format&fit=crop' },
                                { key: 'living', icon: Sofa, img: 'https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?q=80&w=1000&auto=format&fit=crop' }
                            ].map((room, index) => (
                                <motion.div
                                    key={room.key}
                                    initial={{ opacity: 0, y: 30 }}
                            ...
                            <div className="lg:w-1/2 relative">
                                ...
                                <div className="grid grid-cols-2 gap-4 relative">
                                    <div className="space-y-4 pt-12">
                                        <img className="rounded-2xl shadow-xl w-full" src="https://images.unsplash.com/photo-1544457070-4cd773b1d9af?q=80&w=600" alt="Closet Detail 1" />
                                        <img className="rounded-2xl shadow-xl w-full" src="https://images.unsplash.com/photo-1595844730298-b9f0ff98fee0?q=80&w=600" alt="Closet Detail 2" />
                                    </div>
                                    <div className="space-y-4">
                                        <img className="rounded-2xl shadow-xl w-full" src="https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?q=80&w=600" alt="Closet Detail 3" />
                                        <img className="rounded-2xl shadow-xl w-full" src="https://images.unsplash.com/photo-1567080597797-27c277e5a03f?q=80&w=600" alt="Closet Detail 4" />
                                    </div>
                                </div>
                            </div>
                        </div>
