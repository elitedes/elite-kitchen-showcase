...
import { Shield, ShieldCheck, Waves, X, Thermometer, VolumeX, Magnet, PaintBucket, Wrench, CircleCheckBig, ArrowRight, Sparkles } from 'lucide-react';
      ...
      <div className="bg-[#FAF8F5] min-h-screen font-sans selection:bg-accent selection:text-white" dir={dir}>
        ...
        <section className="relative min-h-[80vh] w-full flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-20 container mx-auto px-4 pt-20 flex flex-col items-center justify-center text-center">
            ...
            >
              <p className="text-xl md:text-2xl font-light text-white/90 mb-8 max-w-2xl mx-auto drop-shadow-md">
            ...
            >
              <motion.button
                ...
                className={`group relative px-10 py-5 bg-white text-charcoal rounded-full font-bold text-lg overflow-hidden flex items-center gap-3 w-fit shadow-2xl mx-auto`}
              >
                <span className="relative z-10">
                  {language === 'he' ? 'לחשב את הפרויקט שלך' : language === 'ru' ? 'Рассчитать ваш проект' : 'Calculate Your Project'}
                </span>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-white via-accent/10 to-white opacity-0 group-hover:opacity-100 transition-opacity" />
              </motion.button>
            </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-2xl font-bold text-charcoal mb-4 flex items-center gap-3">
                    ...
                    {language === 'he' ? 'גימור יוקרתי (שלייפלאק)' : language === 'ru' ? 'Роскошная отделка (Шляйфлак)' : 'Luxury Finish (Schleiflack)'}
                  </h3>
