...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'hero.cta.calculator': 'חשבון עלות מטבח',
    ...
    'nav.closets': 'ארונות',
    'page.closets.title': 'ארונות על заказ: купе и распашные модели для любого интерьера',
  ...
  ru: {
    ...
    'nav.closets': 'Шкафы',
    'page.closets.title': 'Шкафы на заказ: купе и распашные модели для любого интерьера',
  ...
  en: {
    ...
    'nav.closets': 'Closets',
    'page.closets.title': 'Custom Closets: Sliding and Hinged Models for Any Interior',
