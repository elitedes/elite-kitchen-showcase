...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'featured.project1.title': 'מטבח מודרני לבן',
    'featured.project1.city': 'אשקלון',
    'featured.project2.title': 'מטבח כפרי יוקרתי',
    'featured.project2.city': 'אשדוד',
    'featured.project3.title': 'מטבח נאנו גרפיט',
    'featured.project3.city': 'ראשון לציון',
    'nav.closets': 'ארונות',
    ...
    'fitting.subtitle': 'Design Fitting',
  ...
  ru: {
    ...
    'featured.project1.title': 'Современная белая кухня',
    'featured.project1.city': 'Ашкелон',
    'featured.project2.title': 'Роскошная кухня кантри',
    'featured.project2.city': 'Ашдод',
    'featured.project3.title': 'Нано кухня графит',
    'featured.project3.city': 'Ришон-ле-Цион',
    'nav.closets': 'Шкафы',
  ...
  en: {
    ...
    'featured.project1.title': 'Modern White Kitchen',
    'featured.project1.city': 'Ashkelon',
    'featured.project2.title': 'Luxury Country Kitchen',
    'featured.project2.city': 'Ashdod',
    'featured.project3.title': 'Nano Graphite Kitchen',
    'featured.project3.city': 'Rishon LeZion',
    'nav.closets': 'Closets',
