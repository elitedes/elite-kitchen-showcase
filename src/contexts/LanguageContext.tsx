...
const translations: Record<Language, Record<string, string>> = {
  he: {
    ...
    'about.description': 'מחפשים את מטבח החלומות שלכם? ב-Elite Design אנו מתמחים בתכנון, עיצוב וייצור מטבחים יוקרתיים המשלבים אסתטיקה בלתי מתפשרת עם פונקציונליות חכמה. אנו מלווים אתכם משלב התכנון הראשוני ועד להתקנה המושלמת בביתכם, תוך שימוש בחומרי הגלם האיכותיים ביותר בשוק.',
  ...
  ru: {
    ...
    'about.decorative': 'Design. Quality. Individuality.',
    'about.description': 'Ищете кухню своей мечты? В Elite Design мы специализируемся на планировании, дизайне и производстве элитных кухонь, сочетающих бескомпромиссную эстетику с умной функциональностью. Мы сопровождаем вас от этапа первоначального планирования до идеальной установки в вашем доме, используя самое качественное сырье на рынке.',
  ...
  en: {
    ...
    'about.decorative': 'Design. Quality. Individuality.',
    'about.description': 'Looking for your dream kitchen? At Elite Design, we specialize in the planning, design, and manufacturing of luxury kitchens that combine uncompromising aesthetics with smart functionality. We guide you from the initial planning stage to the perfect installation in your home, using the highest quality materials on the market.',
